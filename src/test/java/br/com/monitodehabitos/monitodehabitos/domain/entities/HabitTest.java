...
class HabitTest {
    ...
    void scenario03() throws HabitExeption {
        ...
        Assertions.assertEquals(LocalDate.of(2024, 9, 14), habit.getEnd());
    }
    ...
    void scenario04() throws HabitExeption {
        Client client = Mockito.mock(Client.class);
        FactoryHabit factoryHabit = new FactoryHabit();
        Habit habit = factoryHabit.withDescriptionAndDate(client, "Descrição genéria de algo", LocalDate.of(2024, 9, 8));
